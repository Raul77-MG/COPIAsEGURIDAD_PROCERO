...
botonCasa.addEventListener('click', function() {
    ...
    casaFormulario.style.display = 'block'; // Mostrar casaFormulario
    edificioFormulario.style.display = 'none'; // Ocultar edificioFormulario
});

botonEdificio.addEventListener('click', function() {
    reiniciarValoresCasa();
    casaFormulario.style.display = 'none'; // Ocultar casaFormulario
    edificioFormulario.style.display = 'block'; // Mostrar edificioFormulario
});
...
function reiniciarValoresCasa() {
    ...
    // Resto de campos que necesiten reinicio
...
function cambiandoNroPisosEdificio() {
    ...
    for (let i = 0; i < numeroPisosEdificio; i++) {
        ...
        pisoFormEdificio.appendChild(formularioEdificio);
